...
function test() {
    ...
    // getUpcomingDueDates
    testSuite.testEachArgumentOfMethod(argumentValues, holidayCalendar.getUpcomingDueDates.bind(holidayCalendar), [25, 'objectToTest'], "getUpcomingDueDates");
    // getId
    ...
    // getUpcomingEvents
    testSuite.testMethodThenCall(holidayCalendar.getUpcomingEvents.bind(holidayCalendar), [[10], [20], [30]], "getDate", "getUpcomingEvents", true);
    // getUpcomingDueDatesList
    testSuite.testEachArgumentOfMethod(argumentValues, holidayCalendar.getUpcomingDueDatesList.bind(holidayCalendar), [25, 'objectToTest'], "getUpcomingDueDatesList");
