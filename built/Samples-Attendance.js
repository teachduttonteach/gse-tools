        ...
        if (e.getRow() == 1) {
            if ((e.getColumn() == 1) || (e.getColumn() == 3)) {
                ...
                if (currentRow[0][0] && currentRow[0][2]) {
                    ...
                    let records = sheet.getRecordsMatchingColumnValue("Period", currentRow[0][0], ["Full Name", "HP", currentRow[0][2]]);
...
function updateDateCodes() {
    ...
    let dailySchedule = sheet.getValues(1, 1, sheet.getLastRow(), sheet.getLastColumn());
    let daysOfWeek = new MapGS();
