...
import {AssigneeMode, CourseWorkState, CourseWorkType,
  SubmissionModificationMode} from './Enums';
...
export type CourseWorkResource = {
  ...
  individualStudentsOptions:
    GoogleAppsScript.Classroom.Schema.IndividualStudentsOptions,
  /**
  ...
  multipleChoiceQuestion:
    GoogleAppsScript.Classroom.Schema.MultipleChoiceQuestion
}
