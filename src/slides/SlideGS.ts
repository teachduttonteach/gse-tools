 ...
 */
export function replaceSlideImage(obj: SlideGS, picture: GoogleAppsScript.Base.BlobSource,
    imageNumber: number = 0): number {
 ...
 * @return {SlideGS} the object for chaining
 */
export function setSlideList(obj: SlideGS, text: string,
    bulletType: GoogleAppsScript.Slides.ListPreset =
    SlidesApp.ListPreset.DISC_CIRCLE_SQUARE): SlideGS {
 ...
 * @return {SlideGS} the object for chaining
 */
export function addSlideItems(obj: SlideGS, questionOptions: string | Array<string>,
    bulletType: GoogleAppsScript.Slides.ListPreset =
    SlidesApp.ListPreset.DISC_CIRCLE_SQUARE): SlideGS {
 ...
 * @return {SlideGS} the object for chaining
 */
export function addSlideItem(obj: SlideGS, type: string, itemsToAdd: string | Array<string>,
    bulletType: GoogleAppsScript.Slides.ListPreset =
    SlidesApp.ListPreset.DISC_CIRCLE_SQUARE): SlideGS {
 ...
 */
export function changeSlidePicture(obj: SlideGS, chosenPictureBlob: GoogleAppsScript.Base.BlobSource,
 ...
 * @return {SlideGS} the object for chaining
 */
export function positionSlidePicture(obj: SlideGS, id: number, bottom: boolean = true,
    right: boolean = true): SlideGS {
...
export class SlideGS {
     ...
     * @return {number} the number of the page element of the replaced picture
     */
    replaceImage(picture: GoogleAppsScript.Base.BlobSource,
        imageNumber: number = 0): number {
      if (picture == null) {
     ...
     * @return {SlideGS} the object for chaining
     */
    addItems(questionOptions: string | Array<string>,
        bulletType: GoogleAppsScript.Slides.ListPreset =
        SlidesApp.ListPreset.DISC_CIRCLE_SQUARE): SlideGS {
     ...
     * @return {SlideGS} the object for chaining
     */
    addItem(type: string, itemsToAdd: string | Array<string>,
        bulletType: GoogleAppsScript.Slides.ListPreset =
        SlidesApp.ListPreset.DISC_CIRCLE_SQUARE): SlideGS {
      switch (type) {
     ...
     * @return {SlideGS} the object for chaining
     */
    positionPicture(id: number, bottom: boolean = true,
        right: boolean = true): SlideGS {
      if (id == null) {
