...
export class ClassroomDocsGS extends DocsGS {
   ...
   */
  writeClassroomDocuments(data: ClassInfo, topicName: string,
    ...
    } else thisChild.asParagraph().setHeading(thisLevel).setText(thisTitle);
   ...
   */
  private _displayMaterial(materials: Array<Material>,
