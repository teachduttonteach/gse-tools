 ...
 */
export function areDatesEqual(date1: Date | string, date2: Date | string,
    level: string = 'YEAR'): boolean {
  if (!(date1 instanceof Date) || !(date2 instanceof Date) ||
    (typeof date1 !== typeof date2)) return false;
...
export function compareDates(date1: Date | string, date2: Date | string,
  greaterThan: boolean = true, equal: boolean = true, level: string = 'YEAR'): boolean {
